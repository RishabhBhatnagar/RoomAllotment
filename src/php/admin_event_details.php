...
<body>
	...
	<?php
		...
		$eventDetails=get_table_data_query("
			select u.comm_name, e.title, b.event_date, e.description, e.room_no, b.start_time, b.end_time, e.tags, e.type, b.booking_time, u.fac_head, e.status  
		...
		$alliasKeys=array("comm_name"=>"COMMITTEE NAME","booking_time"=>"BOOKING TIME", "event_date"=>"EVENT DATE", "start_time"=>"START TIME", "end_time"=>"END TIME", "description"=>"DESCRIPTION", "title"=>"TITLE / EVENT NAME", "tags"=>"TAGS", "type"=>"TYPE", "room_no"=>"ROOM NO.", "eid"=>"EVENT ID","fac_head"=>"FACULTY INCHARGE","status"=>"STATUS");
	?>
